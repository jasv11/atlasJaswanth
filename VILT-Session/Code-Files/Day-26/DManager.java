...
public class DManager {
    ...
    private DManager() {
        ...
        System.out.println("DManager singleton instance created");
    }
    ...
    public static synchronized DManager getInstance() {
        if (instance == null) {
            ...
            System.out.println("New DManager instance created");
        } else {
            System.out.println("Returning existing DManager instance");
        }
        return instance;
    }
